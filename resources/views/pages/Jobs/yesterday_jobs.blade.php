...
@section('content')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Jobs For Yesterday <strong>({{ \Carbon\Carbon::parse($yesterday)->format('l j F Y')}}
                    )</strong></h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">


            <a href="{{ route("customer.all") }}" class="btn btn-warning btn-icon-text me-1 mb-2 mb-md-0">
                <i class="btn-icon-prepend" data-feather="paper"></i>
                All Customers
            </a>
            <a href="{{ route("jobs.history") }}" class="btn btn-info btn-icon-text me-1 mb-2 mb-md-0">
